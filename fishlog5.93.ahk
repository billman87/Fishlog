...
ENABLE_DEBUG_VENDOR = 0
ENABLE_DEBUG_SAMPKEYS = 0
...
AFKPROTECT_LOGON = 1
AFKPROTECT_DEATH = 1
AFKPROTECT_TIME = 1800000
GIVETIPAMOUNT = 100000
PIMP_AMOUNT = 25
AUTO_UPS_ACCEPT = 1
ALARM_WEEK_ALMOST_OVER = 1
PLAYER_IN_HOTEL = 0 
TIMEDELAY_VEHC = 1000
...
PERSONALITY_TIP_COOLDOWN = 0
PERSONALITY_ARSON_COOLDOWN = 0
PERSONALITY_CLIPTO_COOLDOWN = 0
PERSONALITY_TIP = 1
PERSONALITY_TIPPER_TIMMER = 5000
...
IfNotExist, Hotkeys.ini
{
	...
	CMD_PIMP_DEFUALT=pimp|pimpcall|pimpaccept|pimphelp|pimpinfo|pimpleave|pimpleaveall|pimpmsg|pimprefus|pimp__ply_10|pimp__ply_20|pimp__ply_30|pimp__ply_40|pimp__ply_50
	...
	CMD_action_DEFUALT=ad|bail|beer|belt|buy|cancel|cancelhit|challenge|complain|courier|cnrradio|cure|cureme|delivery|dice|driver|enter|exit|fakeskill|food|givecash|givegift|giverep|heal|healcure|healme|hit|horsebet|housedelivery|items|login|lotto|mechanic|mission|moneybag|parole|payticket|police|possess|prices|refill|register|release|releaseall|rob|robbery|santa|sellcar|sex|shares|sharessell|spawn|strip_10000|sue|tip|tip_1000|tip_10000|tip_100000|tree|ups|weapons
...
BOOT = 1
	...
	Menu, KeybindMenu, Add, SampKeys
	Menu, KeybindMenu, Add, Hotkeys
	Menu, KeybindMenu, Add, Keybinds
	
	Menu, SettingMenu, Add, Logon, 
	Menu, SettingMenu, Add, FishSize,
	Menu, SettingMenu, Add, Automation,
	Menu, SettingMenu, Add, Group,
	Menu, SettingMenu, Add, Hotel,
	Menu, SettingMenu, Add, Horse,
	...
	Menu, CnRMenu,	   Add, Forums,
	Menu, CnRMenu,	   Add, Tencodes,
	Menu, CnRMenu,	   Add, Commands,
	
	Menu, CnRMenu, Add, Home,
	Menu, CnRMenu, Add, Stats,
	Menu, CnRMenu, Add, Global,
	Menu, CnRMenu, Add, Map,
...
if ( X = "ERRROR" ) || ( Y = "ERROR" ) || ( Height = "ERROR" ) || ( Width = "ERROR" ) || ( A_ScreenWidth < Width ) || ( A_ScreenHeight < Height ) || ( X = "-32000" ) || ( T = "-32000" )
{
	X = 100
	Y = 100
	Width = 600
	...
	Gui, Show, X%X% Y%Y% H%Height% W%Width% , Crazybobs Cops and Robbers 
	IfExist, %logfile%
...
Random, RANDOM_1_5 , 1 , 5
Random, RANDOM_100_1000 , 100 , 1000
...
if (VAR2 = "PM" ) && (VAR3 = "From" )
	{
		...
		PM_LAST_ID = VAR5
			StringReplace, PM_LAST_ID, PM_LAST_ID, (
			StringReplace, PM_LAST_ID, PM_LAST_ID, )
			StringReplace, PM_LAST_ID, PM_LAST_ID, :	
			
		if VAR7 = %INVITE_HOTEL_WORD%
		{
			INVITE_PLAYER = VAR4
			INVITE_PLAYER_ID := VAR5
			StringReplace, INVITE_PLAYER_ID, INVITE_PLAYER_ID, (
			StringReplace, INVITE_PLAYER_ID, INVITE_PLAYER_ID, )
			StringReplace, INVITE_PLAYER_ID, INVITE_PLAYER_ID, :
			IF HOTEL_INVITE_ENABLE = 1
			{
				gosub HOTEL_INVITE
				SetTimer, HOTEL_INVITE_SEND, 1000
				LV_Add("", " V5 " VAR5 " ID " INVITE_PLAYER_ID )
			}
		}
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
if VAR2 = "The" VAR3 = "server" VAR4 = "is" VAR5 = "restarting.."
	if AFKPROTECT_LOGON = 1
		SendInput {f4}

; Your Medical Fees Have Been Covered By Life Insurance. - Kills: 0   Days Alive: 2
...
if ( VAR2 = "Type" ) && ( VAR3 = "{D6D631}/fire" ) && ( VAR4 = "{FFFFFF}To" ) && ( VAR5 = "Start" ) && ( VAR6 = "A" ) && ( VAR7 = "{FF0000}Fire{FFFFFF}." )
...
if ( VAR2 = "You" ) && ( VAR3 = "Must" ) && ( VAR4 = "Be" ) && ( VAR5 =  "In" ) && ( VAR6 = "A" ) && ( VAR7 = "Vehicle" ) && ( VAR8 = "To" ) && ( VAR9 = "Change" ) && ( VAR10 = "It's" ) && ( VAR11 = "Color.")
{
	if ENABLE_DEBUG = 1
				LV_Add("", "# Must Be in Vehicle to color")
...
if ( VAR2 = "The" ) && ( VAR3 = "Color" ) && (  VAR4 = "Of" ) && ( VAR5 = "Your" ) ;  Squallo Has Been Changed For $100.  New Color: 3 , 6
...
if VAR3 = Color
	{
		...
		DONATOR = 1
		PLAYER_IN_CAR := VAR6
		PLAYER_IN_CAR_COLOR_1 :=  VAR15
		PLAYER_IN_CAR_COLOR_1 :=  VAR17
		
		if ENABLE_DEBUG = 1
			LV_Add("", "# Color Applied " VAR6 " C1 " VAR15 " C2 " VAR17)
		return
	}
...
if ( VAR2 = "Welcome" ) && ( VAR3 = "To" )
{
	...
	if ( VAR4 = "{00AAFF}24/7" ) || ( VAR4 = "{00AAFF}Xoomer") || ( VAR4 = "{00AAFF}Well" ) || ( VAR4 = "{00AAFF}Burger" ) || ( VAR4 = "{00AAFF}Cluckin'" )  || ( VAR4 = "{00AAFF}The" ) || ( VAR4 = "{00AAFF}Ammunation{FFFFFF}.") || ( VAR5 = "Sex" )	|| ( VAR4 = "{00AAFF}Binco{FFFFFF}.") || ( VAR4 = "{00AAFF}SubUrban{FFFFFF}." ) || ( VAR4 = "{00AAFF}ProLaps{FFFFFF}." ) || ( VAR4 = "{00AAFF}Victim{FFFFFF}." ) || ( VAR4 = "{00AAFF}Didier" )	|| ( VAR4 = "{00AAFF}Zip{FFFFFF}.") || ( VAR5 = "Barber" ) || ( VAR6 = "Shop{FFFFFF}." ) || ( VAR5 = "Crack" ) || ( VAR6 = "House{FFFFFF}." ) ||  ( VAR5 = "Diner{FFFFFF}." ) || ( VAR5 = "Bar{FFFFFF}." ) || ( VAR4 = "{00AAFF}SupaSave{FFFFFF}.") || ( VAR5 = "General" ) || ( VAR5 = "Convenience" ) 
	{
		...
		if HAVEFISH = 1
		{
		if ( VAR4 = "{00AAFF}24/7" ) ( VAR4 = "{00AAFF}Xoomer") || ( VAR4 = "{00AAFF}Well" ) || ( VAR4 = "{00AAFF}Burger"  || ( VAR4 = "{00AAFF}Cluckin'" ) )  || ( VAR5 = "General" )|| ( VAR5 = "Convenience" ) || ( VAR5 = "Diner{FFFFFF}." )
			{
				SendInput {Shift}
...
if ( VAR2 = "You" ) && ( VAR3 = "Have" ) && ( VAR4 = "Been" ) && ( VAR5 = "Attacked" ) && ( VAR6 = "By" ) && ( VAR7 = "A" ) && ( VAR8 = "Sea" ) && ( VAR9 = "Monster" ) ; Who Ate 10 Of Your Fish.
{
 ...
 if (  VAR2 = "You" ) && (  VAR3 = "Have" ) && (  VAR4 = "Been" ) && (  VAR5 = "Attacked" ) && (  VAR6 = "By" ) && (  VAR7 = "A" ) && (  VAR8 = "Sea" ) && (  VAR9 = "Monster," ) && (  VAR10 = "But" ) && (  VAR11 = "You" ) && (  VAR12 = "Scared" ) && (  VAR13 = "It" ) && (  VAR14 = "Away." ) 
...
if ( VAR2 = "You" ) && ( VAR3 = "Have" ) && ( VAR4 =  "Caught" ) && ( VAR5 = "A" ) && ( VAR6 = "Sunken" ) && ( VAR7 = "Treasure" ) && ( VAR8 = "Worth" )
{
	if ENABLE_DEBUG_FISH = 1
...
if ( VAR2 = "{FFFFFF}SA-MP" ) && ( VAR4 = "{FFFFFF}Started" )
{
...
if ( VAR2 = "Connecting" ) && ( VAR3 = "to" )
{
	StringTrimRight, VAR4, SERVERIP, 3
	if ENABLE_DEBUG_SERVER = 1
		LV_Add("", "# Connecting " SERVERIP)
		if FPSINITAL = 0
		{
			gosub FPSHIGH
			FPSINITAL = 1
...
if (  VAR2 = "{FF0000}Warning!" ) && (  VAR4 = "{FFFFFF}This" ) && (  VAR5 = "Server" ) && (  VAR6 = "(and" ) && (  VAR7 = "GTA" ) && (  VAR8 = "In" ) && (  VAR9 = "General)" ) && (  VAR10 = "Contains" ) && (  VAR11 = "Explicit" ) && (  VAR12 = "Material." )
{
	PLAYER_LOG_ON = 0
	ISCRAZYBOBS = 1
	return
 ...
 if (  VAR2 = "This" ) && (  VAR3 = "Name" ) && (  VAR4 = "Is" ) && (  VAR5 = "{FF0000}Already" ) && (  VAR6 = "Registered{FFFFFF}." ) && (  VAR7 = "" ) && (  VAR8 = "Please" ) && (  VAR9 = "Login" ) && (  VAR10 = "or" ) && (  VAR11 = "Change" ) && (  VAR12 = "Your" ) && (  VAR13 = "Name." ) 
{
	if ENABLE_DEBUG_SERVER = 1
		LV_Add("", "# Server Warning")
	if ( AUTOLOGONON = "0"  ) || ( PLAYER_LOG_ON = "1" ) ||  ( ISCRAZYBOBS = "0" )
		return
	if ( AUTOLOGONON = "1"  ) && ( PLAYER_LOG_ON = "0" ) &&  ( ISCRAZYBOBS = "1" )
	Gosub login
	return
}

if ( VAR2 = "Logged" ) && ( VAR3 = "In" ) && ( VAR4 = "As" )
{
	if ENABLE_DEBUG_SERVER = 1
		LV_Add("", "# Server Login")
...
if ( VAR2 = "Data" ) && ( VAR3 = "Loaded" ) && ( VAR4 = "-" ) && ( VAR5 = "Continuing" ) && ( VAR6 = "Current" ) && ( VAR7 = "Life..." )
{
	if ENABLE_DEBUG_SERVER = 1
...
if ( VAR2 = "Type" ) && ( VAR3 = "{D6D631}/instafix" ) && ( VAR4 = "{FFFFFF}In" ) && ( VAR6 = "Vehicle" ) ; To Repair It Instantly.
{	
	if ENABLE_DEBUG_VEHILCE = 1
		LV_Add("", "# Trucking Now?")
	
	PLAYER_IN_VEHICLE = 1
	settimer, HOTKEY_vehc, %TIMEDELAY_VEHC%
	return
}
...
if AUTOLOTTOON = 1
{
	...
	{
		LV_Add("","!! Lotto Winning Number " VAR4 " " )
		if LOTTO_OUT = 1
			FileAppend, %ADDLINE%`n, Lotto.txt
		SetTimer, lotto, 1000
		LOTTOPLAYED = 0
		LOTTOFAIL = 0
		return
...
if ( VAR2 = "You" ) && ( VAR3 = "Are" ) && ( VAR4 = "Not" ) && ( VAR5 = "In" ) && ( VAR6 = "A" ) && ( VAR7 = "Hotel" ) && ( VAR8 = "Room." )
{
	PLAYER_IN_HOTEL = 0
	return
}

if ( VAR4 = "Has" ) && ( VAR5 = "Invited" ) && ( VAR5 = "You" ) && ( VAR5 = "To" ) && ( VAR5 = "Join" ) && ( VAR5 = "The" ) && ( VAR5 = "Group" ) ; && ( VAR5 = "TRAFFIC" )
	{
		if ENABLE_DEBUG = 1
				LV_Add("","Join Group")
		if AUTOGROUP_JOIN = 1
...
if ( VAR2 = "Type" ) && ( VAR4 = "/groupjoin" ) && ( VAR4 = "to" ) && ( VAR5 = "Join" ) && ( VAR6 = "the" ) && ( VAR7 = "Group." )
	{
		if ENABLE_DEBUG = 1
				LV_Add("","Join Group")
		if AUTOGROUP_JOIN = 1
...
if (  VAR2 = "The" ) && (  VAR3 = "IRS" ) && (  VAR4 = "Has" ) && (  VAR5 = "Ordered" ) && (  VAR6 = "You" ) && (  VAR7 = "To" ) && (  VAR8 = "Pay" ) && (  VAR9 = "Taxes." ) ; (  VAR10 = "" ) && (  VAR11 = "$148034" ) && (  VAR12 = "" ) && (  VAR13 = "Paid," ) && (  VAR14 = "Thank" ) && (  VAR15 = "You!" ) 
		{
			if ENABLE_DEBUG_MONEY = 1
				LV_Add("","# IRS Taxes " VAR12)
			return
		} 

 if (  VAR2 = "The" ) && (  VAR3 = "Week" ) && (  VAR4 = "Is" ) && (  VAR5 = "Almost" ) && (  VAR6 = "Over." ) && (  VAR7 = "" ) && (  VAR8 = "Changing" ) && (  VAR9 = "Cities" ) && (  VAR10 = "In" ) && (  VAR11 = "1" ) && (  VAR12 = "Game" ) && (  VAR13 = "Hour." ) 
{
	if ENABLE_DEBUG_SERVER = 1
		LV_Add("","# Server Week Almost Over")
	if ALARM_WEEK_ALMOST_OVER = 1
		SoundPlay, *64
	return
} 
...
if VAR2 = The
{
 ...
 if (  VAR2 = "Money" ) && (  VAR3 = "Rush!" ) && (  VAR4 = "" ) && (  VAR5 = "The" ) && (  VAR6 = "Mafia" ) && (  VAR7 = "Has" ) && (  VAR8 = "Lost" ) && (  VAR9 = "A" ) && (  VAR10 = "Bag" ) && (  VAR11 = "of" ) && (  VAR12 = "Money" ) && (  VAR13 = "Somewhere" ) && (  VAR14 = "In" ) ;; (  VAR15 = "Angel" ) && (  VAR16 = "Pine." ) 
	{
		if ENABLE_DEBUG_HELP = 1
			LV_Add("", "# Bonus Money Rush /mr " VAR15 " " VAR16)
		if AUTOBONUSON = 1
			gosub moneyrush
		return
	}
...
if VAR3 = Time:
{
	...
	if ( AUTOPLAYDICE = "1" ) && ( LASTDICEFAIL = "0" )
	{
	...
	if PLAYER_IN_VEHICLE =  1
	{
		...
		{	
			CAR_COLOR_A++
			IfGreaterOrEqual, CAR_COLOR_A,  %COLOR_TIMER%
			{
				cmd("/vehc " COLORN1 " " COLORN2)
				CAR_COLOR_A = 0
			}
		}
	}			
...
if ( VAR2 = PlayerName ) && ( VAR4 = "Died." ) && ( VAR6 = "Killed" ) && ( VAR7 = "By:" ) ; [GaZa].,:AL3:., (65)
	{
		if ENABLE_DEBUG_DEAD = 1
		LV_Add("","!! Dead " VAR2 " " VAR3 " Killed " VAR8 " " 9)		
		IfNotInString , DEATHS , %VAR2%
			DEATHS = %DEATHS% %VAR2% %a_space%
		DEAD = %VAR2%
			IfNotInString , MURDERS , %VAR10%
			MURDERS = %MURDERS% %VAR10% %a_space%
		if AFKPROTECT_DEATH = 1
			SendInput {f4}
	return
}
if ( VAR2 = PlayerName ) && ( VAR4 = "Died." )
	{
		if ENABLE_DEBUG_DEAD = 1
...
if ( VAR4 = "Has" ) && ( VAR5 = "Been" ) && ( VAR6 = "Shot" ) && ( VAR7 = "For" ) && ( VAR8 = "Being" ) && ( VAR9 = "On" ) && ( VAR10 = "Police" ) && ( VAR11 = "Property." )
{
	if ENABLE_DEBUG_DEAD = 1
	{
...
if VAR5 = Puked
{
 ...
 if (  VAR2 = "The" ) && (  VAR3 = "Chicken" ) && (  VAR4 = "Killed" ) ; && (  VAR5 = "ciyber" ) && (  VAR6 = "in" ) && (  VAR7 = "00:07:10." ) 
{
	if ENABLE_DEBUG_DEAD = 1
...
if ( VAR2 = "You" ) && ( VAR3 = "Have" ) && ( VAR4 = "Been" ) &&  && ( VAR5 = "Issued" ) && (VAR6 = "A" ) && (VAR7 = "Ticket" ) && ( VAR8 = "by" ) && ( VAR9 = "Officer" )
{
	if ENABLE_DEBUG_CRIME = 1
		LV_Add("", "% Crime Ticket Issued by " VAR9 " Fine " VAR14)
	
	SetTimer , pay , 1000
	PLAYER_TICKETS_PAIED += VAR14
	return
}
		
if ( VAR2 = "Type" ) && ( VAR4 = "/pay" ) && (VAR6 = "To" ) && ( VAR7 = "Pay" ) && ( VAR8 = "Your" ) && ( VAR9 = "Ticket" ) && ( VAR10 = "And" ) && ( VAR11 = "Lower" ) && ( VAR12 = "Your" ) && ( VAR13 = "Wanted" ) && ( VAR14 = "Level" )
{
	if ENABLE_DEBUG_CRIME = 1
		LV_Add("", "% Crime Ticket Issued by " VAR9 " Fine " VAR14)
	SetTimer , pay , 1000
...
if ( VAR2 = "You" ) && ( VAR3 = "Have" ) && ( VAR4 = "Paid" ) && (VAR6 = "Ticket" )
{
	if VAR6 = Ticket	
	if ENABLE_DEBUG_CRIME = 1
...
if ( VAR2 = "You" ) && ( VAR3 = "Have" ) && ( VAR4 = "Been" ) && ( VAR5 = "Selected" ) && ( VAR6 = "For" ) && ( VAR7 = "Jury" ) && ( VAR8 = "Duty." ) ; Type  /jury  To Participate In Voting Within 1 Game Hour.	
		{
...
; [14:45:04] Jail Sentence Appeal - Defendant: Migos. (42) - Verdict: Dismissed (Jury Decision) - Votes:  4 Accepted  8 Denied
...
;Purchased Body Armor From FerNando52 (88) For $2019.

 if VAR2 = Purchased  
 if ( VAR5 = "From" ) || ( VAR6 = "From" ) || ( VAR7 = "From" ) 
{
		;if ENABLE_DEBUG_VENDOR = 1
			LV_Add("","# Purchased " VAR4 " " PERSONALITY_TIP )
		if PERSONALITY_TIP = 1
			{
				settimer, HOTKEY_tip_100000, 5000
			}
		return
	}	
	

if (  VAR2 = "Purchased" )  && (  VAR4 = "grams" ) && (  VAR5 = "of" ) && (  VAR6 = "Drugs" ) && (  VAR7 = "From" ) 
{
		if ENABLE_DEBUG_VENDOR = 1
			LV_Add("","# Purchased Drugs " VAR8 " " VAR3 " Grams" )
		return
	}

if (  VAR2 = "Purchased" ) && (  VAR6 = "For" ) && (  VAR10 = "New" ) && (  VAR11 = "Selling" ) && (  VAR12 = "Price:" ) && (  VAR14 = "each." ) 
{
	if ENABLE_DEBUG_VENDOR = 1
		LV_Add("","# Purchased Refill " VAR2 " " VAR3 )
	return
}
...
if VAR5 = Called
{
	...
	{
		if ENABLE_DEBUG_VENDOR = 1
			LV_Add("","# Called Vendor " VAR2 " " VAR3 " " VAR11 " " VAR12 " " VAR13 " " VAR14 " " VAR15)
		return
	}	
}
if VAR2 = Food
...
if ( VAR2 = "UPS" ) && ( VAR3 = "Delivery:") && ( VAR6 = "Has") && ( VAR7 = "A" ) && ( VAR8 = "Package") && ( VAR9 = "For" ) && ( VAR10 = "You,")
{
	IF ENABLE_DEBUG_WORK = 1
		LV_Add("","$ UPS Delivery From" VAR2 )
	if AUTO_UPS_ACCEPT = 1
		cmd("/ups")
	return
}
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; Horse bet
	...
	if ( VAR2 = "Horse" ) && ( VAR3 = "Race" ) ;  Try Me  Has Won The Race!  Payout: 2:1
	{
		LV_Add(,"Horse Results " VAR5)
		
		Settimer Horsebet, 100
		Settimer HorsebetPlay, 1000
		return
	}	

 if (  VAR2 = "Horse" ) && (  VAR3 = "Bet" ) && (  VAR4 = "-" ) && (  VAR5 = "You" ) && (  VAR6 = "Currently" ) && (  VAR7 = "Have" ) && (  VAR8 = "A" ) && (  VAR9 = "Bet" ) && (  VAR10 = "On" )
		{
		LV_Add(,"Horse " VAR11 " " VAR12 " " VAR13 " " VAR14)
		Settimer HorsebetPlay, off
		return
	}

	if (  VAR2 = "Bet" ) && (  VAR3 = "Amount:" ) ;  Bet Amount: $100     Next Race At: 7:00
	{
		LV_Add(,"Horse Bet  " VAR4 " at " VAR12)
		Settimer HorsebetPlay, off
		return	
	}
	...
	if (  VAR2 = "You" ) && (  VAR3 = "Are" ) && (  VAR4 = "Not" ) && (  VAR5 = "At" ) && (  VAR6 = "An" ) && (  VAR7 = "OTB" ) && (  VAR8 = "Machine." ) 
	{
		LV_Add(,"Horse Not Near Machine")
		Settimer HorsebetPlay, off
		return
	}
...
INIWRITE, %GIVETIPAMOUNT%, %inifile%, 	SETTINGS, GIVETIPAMOUNT
...
INIWRITE, %INVITE_HOTEL_WORD%, %inifile%,		SETTINGS, INVITE_HOTEL_WORD		, cheesepie
INIWRITE, %HOTEL_INVITE_ENABLE%, %inifile%,	SETTINGS, HOTEL_INVITE_ENABLE		, 0


INIWRITE, %HORSE_ENABLE%, %inifile%,	SETTINGS, HORSE_ENABLE
INIWRITE, %HORSE_ODDS%, %inifile%,	SETTINGS, HORSE_ODDS
INIWRITE, %HORSE_AMOUNT%, %inifile%,	SETTINGS, HORSE_AMOUNT
INIWRITE, %HORSE_ODDS_RANDOM%, %inifile%,	SETTINGS, HORSE_ODDS_RANDOM
INIWRITE, %HORSE_AMOUNT_RANDOM%, %inifile%,	SETTINGS, HORSE_AMOUNT_RANDOM
...
INIWRITE, %PERSONALITY_TIP%, %inifile%,		PERSONALITY, 	PERSONALITY_TIP
return
...
INIREAD, GIVETIPAMOUNT, %inifile%, 	SETTINGS, GIVETIPAMOUNT			, 100000
...
INIREAD, INVITE_HOTEL_WORD, %inifile%,		SETTINGS, INVITE_HOTEL_WORD		, cheesepie
INIREAD, HOTEL_INVITE_ENABLE, %inifile%,	SETTINGS, HOTEL_INVITE_ENABLE		, 0

INIREAD, HORSE_ENABLE, %inifile%,	SETTINGS, HORSE_ENABLE			, 0
INIREAD, HORSE_ODDS, %inifile%,	SETTINGS, HORSE_ODDS				, 1
INIREAD, HORSE_AMOUNT, %inifile%,	SETTINGS, HORSE_AMOUNT			, 1000
INIREAD, HORSE_ODDS_RANDOM, %inifile%,	SETTINGS, HORSE_ODDS_RANDOM			, 0
INIREAD, HORSE_AMOUNT_RANDOM, %inifile%,	SETTINGS, HORSE_AMOUNT_RANDOM			, 0
...
INIREAD, PERSONALITY_TIP, %inifile%,		PERSONALITY, 	PERSONALITY_TIP			, 0
...
HOTKEY_vehc:
	SetTimer , %A_ThisLabel% , off
	if ENABLE_DEBUG = 1
		LV_Add("","+ " A_ThisLabel " " PLAYER_IN_VEHICLE )
...
Preferences:
	...
	Gui 4:Add, GroupBox,  x20  y135 w150 h120 					, AFK Protection
	Gui 4:Add, CheckBox,  x30  y160 w70 h20  vAFKPROTECT_LOGON Checked%AFKPROTECT_LOGON%, After logon
	Gui 4:Add, CheckBox,  x30  y190 w70 h20  vAFKPROTECT_DEATH Checked%AFKPROTECT_DEATH%, After death
	Gui 4:Add, CheckBox,  x30  y220 w70 h20  vAFKPROTECT_TIMMER Checked%AFKPROTECT_TIME%, on Idle
	
	Gui 4:Add, GroupBox, 	x170 y5  w300 h120 					, Vehicle Color
	Gui 4:Add, Text, 	 	x190 y30 w60  h20 					, Color 1
	Gui 4:Add, ComboBox,	x260 y30 w90 r8 vCOLOR1 			, %COLOR1%||%COLORLIST%
	Gui 4:Add, Text, 	 	x190 y60 w60  h20 					, Color 2
	Gui 4:Add, ComboBox, 	x260 y60 w90 r8 vCOLOR2 			, %COLOR2%||%COLORLIST%
	Gui 4:Add, Text, 	 	x190 y90 w80  h20 					, Timer (mins)
	Gui 4:Add, Edit, 		x260 y90 w90  vCOLOR_TIMER			, %COLOR_TIMER%
	
	Gui 4:Add, GroupBox, 	x170 y135 w300 h120 				, Amounts
	gui 4:Add, Text, 		x190 y160 w70 h30 					, Bribe
	gui 4:Add, Edit, 		x260 y160 w50 h20 vBRIBEAMOUNT 		, %BRIBEAMOUNT%
	gui 4:Add, Text, 		x190 y190 w70 h30 					, Dice
	gui 4:Add, Edit, 		x260 y190 w50 h20  vPLAYDICEAMOUNT	, %PLAYDICEAMOUNT%
	gui 4:Add, Text, 		x190 y220 w70 h30 					, Tip
	gui 4:Add, Edit, 		x260 y220 w50 h20  vGIVETIPAMOUNT	, %GIVETIPAMOUNT%
	
	Gui 4:Add, Text, 	 x340  y160 w70 						, Use Drugs
	Gui 4:Add, Edit, 	 x410  y160 w50  vDRUGS_TAKE_AMOUNT		, %DRUGS_TAKE_AMOUNT%	
	Gui 4:Add, Text, 	 x340  y190 w70 						, Give Drugs
	Gui 4:Add, Edit, 	 x410  y190 w50  vDRUGS_GIVE_AMOUNT		, %DRUGS_GIVE_AMOUNT%	
...
if ENABLE_DEBUG = 1
	LV_Add("","- " A_ThisLabel)
	run https://forums.crazybobs.net/ucp.php?i=pm&mode=compose&u=524
return
...
Gui 15:Add, CheckBox, x30 y120 w100 h20 vPERSONALITY_TIP	 	Checked%PERSONALITY_TIP%	, Big Tipper
...
txt(x) 
{
	...
	IfInString , x , `%
	{
		Loop, Parse , EDIT_LOOP , `%
		{
			b_index++
			if b_index = 2
				x_out := x_out A_LoopField
			if b_index = 3
			{
				IfInString, A_LoopField , RANDOM 
				{
					loop, parse, A_LoopField, _
					{
						if a_index = 2
							x_rand_1 := A_LoopField
						if a_index = 3
							x_rand_2 := A_LoopField
					}
					Random, x_rand , %x_rand_1% , %x_rand_2%
					x_out := x_out x_rand
				}
				else
					x_out := x_out %A_LoopField%
	...
	LV_Add("","// TXT " x " out " x_out " Chatbox: " CHATBOX) 
    IF CHATBOX = 1
	{
		clipboard =
		SendInput ^a^x 
		SendInput %x_out%{ENTER}	
		IfNotEqual, clipboard , NUL
		{
			SendInput t^V
		}		
...
;LV_Add(,A_ThisLabel " " A_ThisHotkey)
return

PERSONALITY_MOURN_COOLDOWN:
SetTimer, %A_ThisLabel%, off
if ENABLE_DEBUG = 1
	LV_Add("", " Person Mourn Cooldown " PERSONALITY_MOURN_COOLDOWN)
PERSONALITY_MOURN_COOLDOWN = 0
return

PERSONALITY_TIP_COOLDOWN:
SetTimer, %A_ThisLabel%, off
if ENABLE_DEBUG = 1
	LV_Add("", " Person Tip Cooldown " PERSONALITY_TIP_COOLDOWN)
PERSONALITY_TIP_COOLDOWN = 0
return
...
SetTimer, %A_ThisLabel%, off
if ENABLE_DEBUG = 1
	LV_Add("", " Person Clipto Cooldown " PERSONALITY_CLIPTO_COOLDOWN) 
PERSONALITY_CLIPTO_COOLDOWN = 0
return
...
iniread, SampKeys_X  		, SAMPKeys.ini , SETUP, SampKeys_X
iniread, SampKeys_Y 		, SAMPKeys.ini , SETUP, SampKeys_Y
iniread, KEY_COUNT 		, SAMPKeys.ini , SETUP, KEY_COUNT, 5
iniread, KEY_PER_COLLUM	, SAMPKeys.ini , SETUP, KEY_PER_COLLUM, 5
if KEY_PROFILE_LOAD =
	iniread, KEY_PROFILE	, SAMPKeys.ini , SETUP, KEY_PROFILE, 1
else 
	KEY_PROFILE := KEY_PROFILE_LOAD
...
loop, % KEY_COUNT
{
	IniRead, HOTKEY_LOOP	, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_HOTKEY_%A_Index%,
	IniRead, EDIT_LOOP		, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_EDIT_%A_Index% , t/{enter}
	IniRead, CHECK_LOOP		, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_CHECK_%A_Index% , 1
	
	if ( HOTKEY_LOOP != "" ) && ( EDIT_LOOP != "" ) && ( HOTKEY_LOOP != "ERROR" )
			{
				if CHECK_LOOP = 1
				{
					if ENABLE_DEBUG_SAMPKEYS = 1
						LV_Add(, "SampKeys " KEY_PROFILE " " HOTKEY_LOOP " = " EDIT_LOOP )
					Hotkey, IfWinActive, ahk_class %HK_TARGET%
					Hotkey, %HOTKEY_LOOP%   , macro               						;Activate saved hotkeys if found.
					Hotkey, %HOTKEY_LOOP%   , on
					
				}
				if CHECK_LOOP = 0 
				{
					if ENABLE_DEBUG_SAMPKEYS = 1
						LV_Add(, "SampKeys off " HOTKEY_LOOP " " EDIT_LOOP)
					Hotkey, %HOTKEY_LOOP%   , macro
					Hotkey, %HOTKEY_LOOP%   , off
				}
			}
}


Gui 87:Add, Edit, x10 y5 w40   	Number vKEY_COUNT				, %KEY_COUNT%
gui 87:add, UPDOWN,  Range1-60									, %KEY_COUNT%
Gui 87:Add, Edit, x50 y5 w40 	Number Limit2 vKEY_PER_COLLUM 	, %KEY_PER_COLLUM%
gui 87:add, UPDOWN,  Range1-15 									, %KEY_PER_COLLUM%
gui 87:add, Text, x100 y5 w30									, Profile
GUI 87:ADD, Edit, x140 y5 w40 	Number vKEY_PROFILE 			, %KEY_PROFILE%
gui 87:add, UPDOWN,  Range1-100 vKEY_PROFILE_LOAD				, %KEY_PROFILE%

Gui 87:Add, Button, x190 y5 h25 w50, Save
Gui 87:Add, Button, x250 y5 h25 w50, Load


if KEY_COUNT > 60
	KEY_COUNT = 60
if KEY_PER_COLLUM > 15
	KEY_PER_COLLUM = 15

loop, % KEY_COUNT
{
	B_index++
	HOTKEY_Index = HOTKEY_%A_Index%
	HOTKEY_LOOP := HOTKEY_%A_Index%
	EDIT_Index 	= EDIT_%A_Index%
	EDIT_LOOP 	:= EDIT_%A_Index%
	
	CHECK_Index = CHECK_%A_Index%
	CHECK_LOOP := CHECK_%A_Index%

	;IniRead, KEY_PROFILE		, SAMPKeys.ini, KEYBIND, %KEY_PROFILE% , 1
	IniRead, HOTKEY_LOOP		, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_HOTKEY_%A_Index%,
	IniRead, EDIT_LOOP			, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_EDIT_%A_Index% , t/{enter}
	IniRead, CHECK_LOOP			, SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_CHECK_%A_Index% , 0
	
	
	
	;MsgBox %CHECK_LOOP%
	
	gui 87:add, HOTKEY		, X%GUI_ADD_X_0%  Y%GUI_ADD_Y_0% W%GUI_ADD_W_HOTKEY%	H%GUI_ADD_HOTKEY_H%		vHOTKEY_%A_Index%							,  %HOTKEY_LOOP%	
	gui 87:add, EDIT		, X%GUI_ADD_X_2%  Y%GUI_ADD_Y_0% W%GUI_ADD_W_EDIT% 		H%GUI_ADD_EDIT_H%		v%EDIT_Index%									,  %EDIT_LOOP%
	gui 87:add, CHECKBOX	, X%GUI_ADD_X_3%  Y%GUI_ADD_Y_3% W%GUI_ADD_W_CHECK% 	H%GUI_ADD_CHECK_H%		v%CHECK_Index%	Checked%CHECK_LOOP%	g87ButtonSave	,  Enable
	
	GUI_ADD_Y_0 += GUI_ADD_Y_1
	GUI_ADD_Y_3 += GUI_ADD_Y_1
	
	if B_index = %KEY_PER_COLLUM%
	{
		GUI_ADD_X_0 += GUI_ADD_X_1
		GUI_ADD_X_2 += GUI_ADD_X_1
		GUI_ADD_X_3 += GUI_ADD_X_1
		GUI_ADD_Y_0 = 50
		GUI_ADD_Y_3 = 72
		B_index = 0
	}
...
gui 87:submit, nohide
if A_ThisLabel = SampKeysCheck
{
	gui 87:Destroy
	return
}
...
if SampKeys_Y = ERROR
	SampKeys_Y = 100
gui 87:show, x%SampKeys_X% y%SampKeys_Y% ,SampKeys

return

Submit:
WinGetPos , SampKeys_X, SampKeys_Y, SampKeys_Width, SampKeys_Height, SampKeys
;MsgBox %SampKeys_X% %SampKeys_Y%
gui 87:submit, nohide
return
...
gui 87:submit
gui 87:Destroy
KEY_PROFILE_LOAD := KEY_PROFILE
goto SampKeys
return

IniWrite87:
IniWrite, % SampKeys_X  		, SAMPKeys.ini , SETUP, SampKeys_X
iniWrite, % SampKeys_Y 		, SAMPKeys.ini , SETUP, SampKeys_Y
iniwrite, % KEY_COUNT 		, SAMPKeys.ini , SETUP, KEY_COUNT
iniwrite, % KEY_PER_COLLUM	, SAMPKeys.ini , SETUP, KEY_PER_COLLUM
;iniwrite, % KEY_PROFILE		, SAMPKeys.ini , SETUP, KEY_PROFILE
...
{
	if ( HOTKEY_%A_Index% != "" )
		IniWrite, % HOTKEY_%A_index% , SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_HOTKEY_%A_Index%
	
	StringReplace, EDIT_%A_Index%	,EDIT_%A_Index%	, `n				, {enter}	, A
	StringReplace, EDIT_%A_Index%	,EDIT_%A_Index%	, {enter}{enter}	, {enter}	, A
	
	if ( EDIT_%A_Index% != "" ) || ( HOTKEY_%A_Index% != ERROR )
		IniWrite, % EDIT_%A_index%   , SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_EDIT_%A_Index%
	
	if ( CHECK_%A_Index% != "" )
		IniWrite, % CHECK_%A_index%  , SAMPKeys.ini, KEYBIND, %KEY_PROFILE%_CHECK_%A_Index%
}
return
...
{
	if ENABLE_DEBUG = 1
		LV_Add("","// MACRO " A_ThisHotkey) 
	loop, %KEY_COUNT%
	{
		x_out := 
		b_index = 1
		HOTKEY_LOOP := HOTKEY_%A_Index%
		if HOTKEY_LOOP = %A_ThisHotkey%
		{
			x_out := HOTKEY_LOOP
			EDIT_LOOP 	:= EDIT_%A_Index%
			
			
			IfInString, EDIT_LOOP, `%
			{
				Loop, Parse , EDIT_LOOP , `%
				{
					b_index++
			...
			;LV_Add("","// MACRO " HOTKEY_LOOP " " EDIT_LOOP ) 	
			hotcmdkey(EDIT_LOOP,HOTKEY_LOOP)
			return
		}
	}
}
...
hotcmdkey(x,y) 
{
	...
	ELSE
	{
		...
		StringLen, x_len , x
		x_len -= 7
		StringTrimLeft, x_out_1 , x ,  %x_len% 
		if ( x_out_1 != "{enter}" ) || ( x_out_1 != "{ENTER}" )
		{
			CHATBOX = 1
		}
		if ( x_out_1 = "{enter}" ) || ( x_out_1 = "{ENTER}" )
...
About:
MsgBox,, About, Fishlog %FISHLOG_VER%`n`n Automation Assistan and Keybinder`n For Crazybobs Cops and Robbers `n`n`n Unrelated to SAMP or CBCNR`n`nInquires to billman87
return
...
HOTEL_INVITE_SEND:
settimer, %A_ThisLabel% , off
if ( PLAYER_IN_HOTEL = "1" ) && ( INVITE_PLAYER_ID != "" )
	cmd("/hotelinvite " INVITE_PLAYER_ID )
INVITE_PLAYER_ID = 
return
...
gui 88:add, Checkbox, x10 y50 w30		checked%HOTEL_INVITE_ENABLE%	vHOTEL_INVITE_ENABLE	, Enable
gui 88:add, Text, x80 y50 w100									, Invite Password
GUI 88:ADD, Edit, x190 y50 w100 	vINVITE_HOTEL_WORD		, %INVITE_HOTEL_WORD%
GUI 88:ADD, Button, x10 y90 w40 			, Save

gui 88:show, x100 y100 w350 h150 ,Hotel
...
Horse:
gui 89:Destroy
gui 89:add, Checkbox, x10 y50 w30		checked%HORSE_ENABLE%	vHORSE_ENABLE	, Enable
gui 89:add, Text, x80 y50 w100									, Horse Number
GUI 89:ADD, Edit, x190 y50 w100 Number			, %HORSE_ODDS%
GUI 89:ADD, UpDown, vMyUpDown Range1-5  vHORSE_ODDS ,  %HORSE_ODDS%
gui 89:add, Checkbox, x330 y50 w30		checked%HORSE_ODDS_RANDOM%	vHORSE_ODDS_RANDOM	, Random
gui 89:add, Text, x80 y100 w100									, Bet Amount
GUI 89:ADD, Edit, x190 y100 w100 Number 			, %HORSE_AMOUNT%
GUI 89:ADD, UpDown, vMyUpDown Range100-100000 vHORSE_AMOUNT,  %HORSE_AMOUNT%
gui 89:add, Checkbox, x330 y100 w30		checked%HORSE_AMOUNT_RANDOM%	vHORSE_AMOUNT_RANDOM	, Random
GUI 89:ADD, Button, x10 y100 w40 			, Save

gui 89:show, x100 y100 w400 h150 , Horse Bettting 
...
LV_Add(,"Horseplay")
cmd("/horsebet")
if HORSE_ODDS_RANDOM = 1
{
	Random, HORSE_ODDS_PLAY, 1 , %HORSE_ODDS%
	txt(" " HORSE_ODDS_PLAY)	
}
else
	txt(" " HORSE_ODDS)

if HORSE_AMOUNT_RANDOM = 1
{
	Random, HORSE_AMOUNT_PLAY, 100 , %HORSE_AMOUNT%
	txt(" " HORSE_AMOUNT_PLAY)
}
else
	txt(" " HORSE_AMOUNT)
return